...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.showSatellite = _this.showSatellite.bind(_this);
    _this.renderSatellite = _this.renderSatellite.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    key: 'showSatellite',
    value: function showSatellite(err) {
      this.setState({
        error: err
      });
      (0, _api.getSatelliteById)(this.renderSatellite);
    }
  }, {
    key: 'renderSatellite',
    value: function renderSatellite(err, satellite) {
...
exports.getSatelliteById = getSatelliteById;
...
var issUrl = 'https://api.wheretheiss.at/v1/satellites';

function getSatelliteById(callback) {
  _superagent2.default.get(issUrl + '/25544').end(function (err, res) {
