...
var _PicDetails = __webpack_require__(34);

var _PicDetails2 = _interopRequireDefault(_PicDetails);
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        key: 'renderPic',
        value: function renderPic(err, pic) {
            this.setState({
                error: err,
                pic: pic || []
            });
...
var NASAUrl = 'https://api.nasa.gov/planetary/apod?api_key=I6K2twCnPmfphLSnZ4FB2froZNiDHROwebMSWL1k';

function getPic(callback) {
    _superagent2.default.get(NASAUrl).end(function (err, res) {
